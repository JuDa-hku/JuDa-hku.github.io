...
- SVD is to pick "new" and less coordinate to reconstruct "old" coordinates. Try to minimum reconstruction error. $$U\Sigma$$ of $$A=U\Sigma V^T$$ gives the coordinates of the points in the projection axis. Interpretation 2, is to set smallest singular values to zero. How many $$\simga$$ to keep? Keep 80%-90% of 'energy'.
